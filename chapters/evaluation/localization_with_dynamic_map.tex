...
\todo{maybe Describe how amcl estimates its covariance.}
...
In the first environment shown in figure \ref{fig:location_environment1} a table was tilted, eight cardboard boxes was placed and a whiteboard was placed. 
...
The estimated deviation is generally higher in the third environment where fewer of the laser scans matches with the static map representation as shown in figure \ref{fig:amcl_covariance_dynamic1}. 
