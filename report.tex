...
\def\ThSupervisors{Lars-Peter Ellekilde, 
	Associate Professors at the Mærsk Mc-Kinney Møller Institute of SDU\\ Niels Jul Jacobsen, CTO at Mobile Industrial Robots ApS}
...
\def\ThECTS{40}
\def\ThEducation{Master of Science in Engineering}
...
\include{chapters/long_term_slam/long_term_slam}
\include{chapters/static_mapping/static_mapping}
\include{chapters/mapping_of_dynamic_areas/mapping_of_dynamic_areas}
\include{chapters/cost_interpretation/cost_interpretation}
